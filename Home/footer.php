  ...
  <div class="row">
    ...
    <div class="col-sm-6" >
      <div class="container bottom-menu">
        ...
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="faq/listfaq.php">FAQ</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="feedback/addfeedback.php">Feedbacks</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Giftcard/listgift.php">Gift Cards</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="Admin-Panel/admin-login.php">Admin Login</a>
          </li>
